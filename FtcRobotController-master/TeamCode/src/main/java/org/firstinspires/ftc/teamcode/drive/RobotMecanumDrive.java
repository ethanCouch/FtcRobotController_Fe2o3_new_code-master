...
public class RobotMecanumDrive extends MecanumDrive {
    ...
    public RobotMecanumDrive(HardwareMap hardwareMap, Telemetry tele) {
        ...
        leftFront  = hardwareMap.get(DcMotorEx.class, "lf"/*"left_front_drive"*/);
        leftRear  = hardwareMap.get(DcMotorEx.class, "lb"/*"left_rear_drive"*/);
        rightFront = hardwareMap.get(DcMotorEx.class, "rf"/*"right_front_drive"*/);
        rightRear = hardwareMap.get(DcMotorEx.class, "rb"/*"right_rear_drive"*/);
